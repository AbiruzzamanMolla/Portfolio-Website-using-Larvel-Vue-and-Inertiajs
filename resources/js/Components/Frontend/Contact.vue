  ...
  <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
    <div class="container mx-auto">
      <div class="flex flex-col items-center text-center">
        ...
        <p class="subtitle">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga veniam labore
          nisium illum cupiditate reiciendis a numquam
        </p>
      </div>
          ...
          <div class="flex flex-col lg:flex-row gap-x-4">
            ...
            <div>
              ...
              <p class="text-accent font-normal">
                Email me at abiruzzaman.molla@gmail.com
              </p>
            </div>
          </div>
          <div class="flex flex-col lg:flex-row gap-x-4">
            ...
            <div>
              ...
              <P class="mb-1 text-paragraph">Narsingdi, Dhaka.</P>
